...
class CollectionManager:
    ...
    def __init__(self, collection_dir: Optional[Path] = None,
        ...
        try:
            from example_projects.autopahe.config import COLLECTION_DIR, COLLECTION_METADATA_FILE
            ...
            try:
                from example_projects.autopahe.ap_core.platform_paths import get_data_dir, get_downloads_dir
        ...
        if collection_dir:
            ...
            try:
                from example_projects.autopahe.ap_core.platform_paths import get_downloads_dir
    ...
    def sync_from_records(self) -> int:
        ...
        updated_count = 0
        try:
            from example_projects.autopahe.features.manager import load_database
