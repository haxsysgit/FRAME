...
from example_projects.autopahe.ap_core.platform_paths import get_cache_dir as _get_platform_cache_dir, ensure_dir
...
def cache_warm(urls: List[str], tags: List[str] = None):
    ...
    """
    from example_projects.autopahe.ap_core.browser import get_request_session, driver_output
