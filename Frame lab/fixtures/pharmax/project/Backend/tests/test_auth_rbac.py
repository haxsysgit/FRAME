...
class AuthTester:
    ...
    def run_all_tests(self):
        ...
        self.register_user("admin", "admin@pharmax.local", "ADMIN")
        self.register_user("cashier", "cashier@pharmax.local", "CASHIER")
        self.register_user("sales", "sales@pharmax.local", "SALES")
