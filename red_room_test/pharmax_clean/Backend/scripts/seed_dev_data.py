...
from example_projects.pharmax.Backend.app.models.stock_adjustment_table import StockAdjustment, StockAdjustmentReason
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Seed the Pharmax DB with sample products.")
